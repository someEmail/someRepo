...
# -*- coding: utf-8 -*-
"""
Created on Thurs Aug 17 11:24:36 2017
...
def simulate(num_doors, switch, steps):
    ...
    if door_to_remove == winning_door or door_to_remove == choice:
       continue
        #memememe assert(door_to_remove == winning_door or door_to_remove == choice),"door to remove is winning door or user choice"
   ...
   #mememmememememe assert(len(closed_doors)==2),"no of doors to choose from is not 2"
